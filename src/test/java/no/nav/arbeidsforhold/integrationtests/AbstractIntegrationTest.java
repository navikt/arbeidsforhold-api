...
import no.nav.arbeidsforhold.api.TestLauncher;
import no.nav.arbeidsforhold.tasks.EvictCacheTask;
...
public abstract class AbstractIntegrationTest {
    ...
    protected static final String IDENT = "03118922580";
    ...
    private static void mockTokenX() throws NoSuchAlgorithmException {
        ...
        System.setProperty("token.x.client.id", "dev-sbs:personbruker:arbeidsforhold-api");
